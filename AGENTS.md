...
1. Accepted product decisions in `docs/implementation-package/docs/00_PRODUCT_DECISIONS.md`
2. Acceptance criteria in `docs/implementation-package/docs/13_ACCEPTANCE_CRITERIA.md`
3. Database contract in `docs/implementation-package/contracts/postgresql-schema.sql`
4. API contract in `docs/implementation-package/contracts/openapi.yaml`
5. Hermes schema in `docs/implementation-package/contracts/hermes-catalog.schema.json`
