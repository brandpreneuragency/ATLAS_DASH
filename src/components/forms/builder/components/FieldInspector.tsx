// FieldInspector — right column of the Build tab.
// Edits the selected field's properties via formsStore.updateField.
// Renders an empty hint when no field is selected.
...
export default function FieldInspector({ form, fieldId }: FieldInspectorProps) {
  ...
  if (!field) {
    return (
      <div className="forms-builder-col forms-builder-inspector">
        <div className="forms-builder-col-head">
          <span className="forms-builder-col-head-title">Inspector</span>
        </div>
        <div className="forms-builder-col-body">
          <div className="forms-builder-inspector-empty">
            <p className="forms-empty-state-title">Select a field to edit its properties.</p>
            <p className="forms-empty-state-subtitle">
              Click a field on the canvas to configure its label, options, validation, and more.
            </p>
          </div>
        </div>
      </div>
  ...
  return (
    <div
      className={`forms-builder-col forms-builder-inspector${
        fieldId ? ' forms-builder-inspector--open' : ''
      }`}
    >
      <div className="forms-builder-col-head">
        <span className="forms-builder-col-head-title">Inspector</span>
        <span
          className="forms-builder-col-head-title"
          style={{ textTransform: 'none', letterSpacing: 0, display: 'inline-flex', alignItems: 'center', gap: 4 }}
        >
